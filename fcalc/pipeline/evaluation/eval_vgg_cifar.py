...
if IS_DEBUG:
	DEBUG_eval_vgg_cifar_LOOP_SIGNAL = 100
else:
	DEBUG_eval_vgg_cifar_LOOP_SIGNAL = 0

def eval_vgg_cifar_0002_test(config_data, tab_level=0, verbose=250):
	print('eval_vgg_cifar_0002_test()')
	...
	eval_cifar_0001(config_data, state_tracker, net, DEBUG_eval_vgg_cifar_LOOP_SIGNAL, train=False, tab_level=0, verbose=250)
