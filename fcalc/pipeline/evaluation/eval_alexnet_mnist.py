...
if IS_DEBUG:
	DEBUG_eval_alexnet_mnist_LOOP_SIGNAL = 100

else:
	DEBUG_eval_alexnet_mnist_LOOP_SIGNAL = 0

def eval_alexnet_mnist_0001_overfitting(config_data, tab_level=0, verbose=250):
	print('eval_alexnet_mnist_0001_overfitting()')
	config_data['data_from_torch']['mnist']['training_mode'] = True
	eval_alexnet_mnist_0001(config_data, tab_level=0, verbose=0)

def eval_alexnet_mnist_0002_test(config_data, tab_level=0, verbose=250):
	print('eval_alexnet_mnist_0002_test().')
	config_data['data_from_torch']['mnist']['training_mode'] = False
	eval_alexnet_mnist_0001(config_data, tab_level=0, verbose=0)

def eval_alexnet_mnist_0001(config_data, tab_level=0, verbose=0):
	...
	emn.eval_mnist_0001(config_data, state_tracker, net, DEBUG_eval_alexnet_mnist_LOOP_SIGNAL, 
