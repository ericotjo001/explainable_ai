...
def seq_alexnet_cifar_upsize(config_data, tab_level=0, verbose=250):
	print('seq_alexnet_cifar_upsize()')
	config_data['data_from_torch']['cifar']['resize'] = (256,256)

	config_data['NO_OF_RUNS'] = 1
	config_data['general']['epoch'] = 5 # NO max epoch per 24 hr
	...
	seq_alexnet_cifar_general(config_data, tab_level=0, verbose=250)

def seq_alexnet_cifar(config_data, tab_level=0, verbose=250):
	print('seq_alexnet_cifar()')
...
def seq_alexnet_cifar_general(config_data, tab_level=0, verbose=250):
	# model/data specific
	...
	this_drivethru_method = sm.drivethru_0001_alexnet_cifar
