...
if IS_DEBUG:
	DEBUG_train_LOOP_SIGNAL = 0
	DEBUG_train_LOOP_SIGNAL2 = 10
else:
	DEBUG_train_LOOP_SIGNAL = 0
	DEBUG_train_LOOP_SIGNAL2 = 0

def DEBUG_train_loop_0001(DEBUG_train_LOOP_SIGNAL, net, x, y0, 
	tab_level=0, verbose=250):
	DEBUG_SIGNAL = 0
	if DEBUG_train_LOOP_SIGNAL:
...
def DEBUG_train_loop_0002(DEBUG_train_LOOP_SIGNAL2, n_iter, n_epoch ,tab_level=0, verbose=0):
	DEBUG_SIGNAL = [0,0]
	# n_epoch n_iter are both zero based
	if DEBUG_train_LOOP_SIGNAL2:
		N_ITER_MAX = 10
		N_EPOCH_MAX = 2
