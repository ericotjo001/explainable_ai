...
if IS_DEBUG:
	...
	DEBUG_DRIVE_TRHU_LOOP = False
	DEBUG_DRIVE_TRHU_LOOP2 = False # (bool)
	
def drivethru_0001_vgg_mnist(config_data, tab_level=0, verbose=250):
	print('drivethru_0001_vgg_mnist(). ')
...
def new_or_load_model(state_tracker, config_data, verbose=0, tab_level=0):
	...
	net = VGGLikeprobe0001(relprop_mode=config_data['lrp']['relprop_mode'], verbose=verbose, tab_level=tab_level)
