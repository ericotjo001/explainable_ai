...
def drivethru_0001_vgg_cifar(config_data, tab_level=0, verbose=250):
	print('drivethru_0001_vgg_cifar()')
	PROGRESS_TRACK_EVERY_N_PERCENT = 5.

	tracker_name = 'drivethru_0001_vgg_cifar'
...
def new_or_load_model(state_tracker, config_data, verbose=0, tab_level=0):
	from models.networks import VGGLikeprobe0001
	net = VGGLikeprobe0001(INPUT_CHANNEL_SIZE=3, relprop_mode=config_data['lrp']['relprop_mode'], verbose=verbose, tab_level=tab_level)
