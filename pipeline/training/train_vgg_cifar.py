...
if IS_DEBUG:
	DEBUG_train_vgg_cifar_LOOP_SIGNAL = 0
	DEBUG_train_vgg_cifar_LOOP2_SIGNAL = 1
else:
	DEBUG_train_vgg_cifar_LOOP_SIGNAL = 0
	DEBUG_train_vgg_cifar_LOOP2_SIGNAL = 0
...
def new_or_load_model(state_tracker, verbose=0, tab_level=0):
	...
	net = VGGLike(INPUT_CHANNEL_SIZE=3, verbose=verbose, tab_level=tab_level)
